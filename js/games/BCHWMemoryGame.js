...
(function (window){
    ...
    BCHWMemoryGame.prototype.loadAssets = function(){
        ...
        var scope = this;
        this.imageStore.loadImages(["assets/memoryGameCardBack.png"], function(){scope.assetsLoadedHandler()});
    };

    BCHWMemoryGame.prototype.assetsLoadedHandler = function(){
        //console.log("BCHWMemoryGame.assetsLoadedHandler()");
        this.cardBackImage = this.imageStore.images[0];
    ...
    BCHWMemoryGame.prototype.imageStoreLoadCompleteHandler = function(){
        ...
        spacer = cellSize*.1;
        cellSize -= spacer;
        cellSize = cellSize > BCHWMemoryGame.MAX_TILE_SIZE ? BCHWMemoryGame.MAX_TILE_SIZE : cellSize;
        ...
        for(i=0;i<this.selectedGrid.rows;i++){
            for(j=0;j<this.selectedGrid.cols;j++){
                cell = new BCHWMemoryGameGridCell(gridRect.x + j*cellSize+ j*spacer, gridRect.y + i*cellSize+ i*spacer, cellSize, cellSize, null, this.context, this.cardBackImage, this.cardsColor );
        ...
        var images = this.imageStore.images.concat();
    ...
    //==========================::BCHWMemoryGameGridCell::=============================
    var BCHWMemoryGameGridCell = function(x, y , width, height, image, context, bgImage, color){
    ...
    BCHWMemoryGameGridCell.prototype = Object.create(BCHWGeom.Rectangle.prototype);
    BCHWMemoryGameGridCell.prototype.constructor = BCHWGeom.Rectangle;
    ...
    BCHWMemoryGameGridCell.prototype.renderBackgroundImage = function(){
        ...
        this.context.fillStyle = BCHWColor.BCHWColorsLib.GREEN.getCanvasColorString();
    ...
    BCHWMemoryGameImagesManager.prototype.getRandomImages = function(total){
        ...
        for(var i=0; i<total; i++){
            images[i] = "assets/memoryGame/"+copy.splice(Math.floor(Math.random()*copy.length), 1)[0];
        }
        return images;
